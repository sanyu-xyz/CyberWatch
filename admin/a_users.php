...
<html lang="en">
    <head>
        ...
        <title> CYBER WATCH  | SECURITY - DASHBOARD</title>
    ...
    <div class="wrapper">
                ...
                <nav class="navbar navbar-default">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header" id="sams">
                            <button type="button" id="sidebarCollapse" id="makota" class="btn btn-sam navbar-btn">
		...
		<div class="panel panel-default sammacmedia">
            <div class="panel-heading">ADD USERS<d/div>
        ...
        <div class="row form-group">
          ...
          <div class="col-lg-6">
            <label>Email</label>
             ...
             <div class="col-lg-6">
            <label>Phone</label>
              <input type="text" class="form-control" name="phone" placeholder="0123456789" pattern="[0-9]{10}">
            </div>  
        </div>   
         <div class="row form-group">
          <div class="col-lg-6">
